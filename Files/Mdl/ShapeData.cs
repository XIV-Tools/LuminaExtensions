...
namespace LuminaExtensions.Files.Mdl
{
	...
	public class ShapeData
	{
		...
		/// </summary>
		public readonly List<ShapeInfo> ShapeInfoList = new List<ShapeInfo>();

		/// <summary>
		/// The shape parts.  Each full shape is composed of
		/// Shape -> [Lods] -> [Parts for those Lods].
		/// </summary>
		public readonly List<ShapePart> ShapeParts = new List<ShapePart>();

		/// <summary>
		/// The Raw shape index list.  This is formatted as
		/// [Base Index To Replace] -> [New Vertex to point to].
		/// </summary>
		public readonly List<ShapeDataEntry> ShapeDataList = new List<ShapeDataEntry>();
		...
		public class ShapeInfo
		{
			...
			/// </summary>
			public readonly List<ShapeLodInfo> ShapeLods = new List<ShapeLodInfo>();
		...
		{
			public readonly List<ShapePart> Parts = new List<ShapePart>();
