...
namespace LuminaExtensions.Files.Mdl
{
	...
	public class MeshData
	{
		...
		/// </summary>
		public readonly List<MeshPart> MeshPartList = new List<MeshPart>();

		/// <summary>
		/// The list of vertex data structures for the mesh.
		/// </summary>
		public readonly List<VertexDataStruct> VertexDataStructList = new List<VertexDataStruct>();

		/// <summary>
		/// A list of the shape paths associated with this mesh.
		/// </summary>
		public readonly List<string> ShapePathList = new List<string>();
